...
with col11:
    st.metric("Aura price", f"${aura_price}",
              f"{pretty(aura_cg['price_change_24h']/aura_price, 2, False)}%/24h")


with col21:
    st.metric("Bal price", f"${bal_price}",
              f"{pretty(bal_cg['price_change_24h']/bal_price, 2, False)}%/24h")

with col31:
    st.metric("Eth price", f"${eth_price}",
              f"{pretty(eth_cg['price_change_24h']/eth_price, 2, False)}%/24h")
